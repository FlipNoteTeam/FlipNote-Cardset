...
export class ErrorCode {
  ...
  // Image (gRPC)
  static readonly IMAGE_NOT_FOUND = new ErrorCode(HttpStatus.NOT_FOUND, 'IMAGE_001', '이미지를 찾을 수 없습니다');
  static readonly IMAGE_INVALID_REQUEST = new ErrorCode(HttpStatus.BAD_REQUEST, 'IMAGE_002', '잘못된 이미지 요청입니다');
  static readonly IMAGE_SERVER_ERROR = new ErrorCode(HttpStatus.INTERNAL_SERVER_ERROR, 'IMAGE_003', '이미지 서버 내부 오류입니다');
  static readonly IMAGE_SERVICE_ERROR = new ErrorCode(HttpStatus.BAD_GATEWAY, 'IMAGE_004', '이미지 서비스 오류입니다');
